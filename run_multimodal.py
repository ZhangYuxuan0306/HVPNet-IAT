...
def main():
    ...
    parser.add_argument('--num_epochs', default=2, type=int, help="num training epochs")
    ...
    parser.add_argument('--sample_ratio', default=0.1, type=float, help="only for low resources.")
